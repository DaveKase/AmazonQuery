...
namespace AmazonQuery.Controllers
{
    public class AmazonApi
    {
        ...
        public JArray GetData(string url, string currId)
        {
            try
            {
        ...
        private double GetGbpRate(string currId)
        {
            string url = "https://openexchangerates.org/api/latest.json?app_id=" + currId;
